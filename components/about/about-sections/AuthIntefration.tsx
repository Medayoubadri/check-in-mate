      ...
      <div className="absolute inset-0 shadow-xl overflow-hidden">
        ...
        <div className="grid grid-cols-2 h-full">
          ...
          <div className="flex flex-col gap-4 p-4 border-r h-fit">
            ...
            {/* Login form */}
            <div className="bg-slate-800 bg-opacity-50 backdrop-blur-sm p-4 border border-slate-700 rounded-lg h-full overflow-hidden -translate-x-8 translate-y-8 group-hover:translate-y-0 group-hover:translate-x-0 transition-transform duration-300 transform">
